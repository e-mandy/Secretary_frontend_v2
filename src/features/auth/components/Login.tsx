      ...
      <div className="w-1/2 h-full flex">
        <div className="m-auto w-1/2">
          <div className="mb-10">
            ...
            <p>
              Connectez vous pour accéder aux informations du secrétariat de
              Esgis.
            </p>
          </div>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              type="submit"
              className="bg-[#c41c2d] w-full text-white py-3 rounded-lg my-6 cursor-pointer active:bg-[#d15c68] flex gap-3 justify-center shadow-lg shadow-[#d15c68]"
            >
              {isPending && (
                <Spinner color="white" height="24" width="24" visible={true} />
              )}
              <p>
                {isPending
                  ? "Chargement"
                  : "Se connecter en tant que sécrétaire"}
              </p>
            </button>
            ...
            <div className="flex gap-4 mt-10">
              ...
              <p>
                Si vous souhaitez avoir un compte sécrétaire, veuillez s'il
                plait contacter l'administration pour exposer votre requête.
                Merci !!
              </p>
            </div>
          </form>
          <p className="py-4">
            ...
            <Link
              ...
              className="text-[#c41c2d] font-semibold"
            >
              Inscrivez-vous !!
            </Link>
          </p>
      ...
      <div className="w-1/2 relative flex flex-col items-center">
        ...
        <div className="flex absolute bottom-50 bg-white/10 backdrop-filter flex-col p-8 rounded-lg backdrop-blur-md">
          ...
          <p className="text-white text-base">
            Une façon plus simple et organisée de faire les choses.
          </p>
        </div>
      </div>
    </div>
