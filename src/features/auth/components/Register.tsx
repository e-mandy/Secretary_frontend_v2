    ...
    <div className="h-screen relative flex">
      <div className="w-1/2 h-screen flex">
        <div className="m-auto w-[55%]">
          <div className="mb-10">
            ...
            <p>
              Bienvenue sur la plateforme de gestion du sécrétariat de Esgis
            </p>
          </div>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              ...
              <p>
                {isPending ? "Chargement" : "S'inscrire en tant que sécrétaire"}
              </p>
            </button>
            <p>
              Vous avez déjà un compte sécrétaire ?{" "}
              <Link
                to="/secretary/login"
      ...
      <div className="w-1/2 h-full flex bg-linear-to-tl from-white to-[#F3E1E3]">
        ...
        <div className="m-auto flex flex-col items-center">
          <img
            className="w-70 h-70 rounded-lg mb-6"
            src={secretaryImg}
            alt=""
          />
